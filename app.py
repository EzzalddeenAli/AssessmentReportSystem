...
def upload_file():
    ...
    class_averages_with_total = list(class_records[0][-3][3:15])

    mean = sum(list(class_records[0][-3][3:14])) / 11

    class_averages_with_mean = list(list(class_records[0][-3][3:14]) + [mean])
